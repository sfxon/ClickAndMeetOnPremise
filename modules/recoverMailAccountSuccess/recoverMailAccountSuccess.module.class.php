...
///////////////////////////////////////////////////////////////////////////////////////////////////
class cRecoverMailAccountSuccess extends cModule {
		...
		public function process() {
				...
				$content = $cms->loadContentDataByKey('RECOVER_MAIL_ACCOUNT_SUCCESS');
				...
				$tmp_content = $renderer->fetch('site/recover_mail_account_success.html');
