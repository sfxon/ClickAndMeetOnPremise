...
///////////////////////////////////////////////////////////////////////////////////////////////////
class cResetPasswordSuccess extends cModule {
		...
		public function process() {
				...
				$content = $cms->loadContentDataByKey('RESET_PASSWORD_SUCCESS');
				...
				$tmp_content = $renderer->fetch('site/reset_password_success.html');
