class mvCmTimer {
		...
		updateWithData(data) {
				...
				$('#editor-appointment-id').val(this.appointment_id);
		...
		showEditor(self) {
				...
				text_datum = "<span>" + $('#mv-text-termin-datum').val() + " </span><strong>" + text_datum + "</strong>";
				text_time = "<span>" + $('#mv-text-termin-zeit').val() + " </span><strong>" + text_time + " Uhr</strong>";
				...
				if(self.event_location_title.length > 0) {
						text_event_location = "<span>" + $('#mv-text-termin-event-location').val() + " </span><strong>" + self.event_location_title + "</strong>";
				} else {
						text_event_location = '&nbsp;';
				}
				
				if(self.user_unit_title.length > 0) {
						text_user_unit = "<span>" + $('#mv-text-termin-user-unit').val() + " </span><strong>" + self.user_unit_title + "</strong>";
				} else {
						text_user_unit = '&nbsp;';
				}
