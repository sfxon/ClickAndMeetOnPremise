class mvCmFilterSaver {
		...
		prepareRequest(queue) {
				...
				var get_params = tmpUploadQueryBuilder.makeByPlatform('blitz', 'mvclickandmeet', 'ajaxUpdateFilter');
		...
		//////////////////////////////////////////////////////////////////
		error_callback() {
				alert('Es ist ein Fehler aufgetreten in adminCmFilterSaver.js. Bitte versuche es erneut. Fehlerdetails findest du in der Konsole.');
		}
}
